      ...
      >
        <v-card height="256">
          <div class="dialog__title">
            <h3 class="text-center">Вы хотите удалить выбранные группы пациентов?</h3>
    ...
    <div>
      ...
      >
        <v-card height="256">
          ...
          <div class="mt-10 text-center">
            <v-btn class="dialog__btn" color="var(--secondary-color)" :disabled="editedItem.nameGroup.length < 3" @click="addGroupPatient">
              Сохранить
            </v-btn>
  ...
  export default {
    data(): any {
      return {
        ...
        elements: [
          ...
          {
            id: 2,
            nameGroup: 'Предприниматели'
          },
          {
            id: 3,
            nameGroup: 'Пенсионеры'
          },
          {
            id: 4,
            nameGroup: 'Дети'
    ...
    methods: {
      deleteGroupPatient() {
        ...
        const newGroup = group.filter(item => !selected.includes(item))
