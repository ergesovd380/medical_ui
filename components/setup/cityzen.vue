      ...
      >
        <v-card height="256">
          <div class="dialog__title">
            <h3 class="text-center">{{ $t('SetupData.Delete_cityzen') }}</h3>
        ...
        <v-card height="256">
          <div class="container">
            ...
            <v-text-field
              ...
              class="dialog__input"
              autocomplete="none"
              v-model="editedItem.nameCityzen"
              type="text"
            ></v-text-field>
          </div>
          <div class="mt-10 text-center">
...
<script lang="ts">
  export default {
    data(): any {
      return {
        ...
        elements: [
          ...
          {
            id: 2,
            nameCityzen: 'Иностранец-дипломат'
          },
          {
            id: 3,
            nameCityzen: 'Иностранец'
          }
        ],
        editedItem: {
          nameCityzen: '',
    ...
    methods: {
      deleteCityzen() {
        const cityzen = this.elements
        const selected = this.selected
        const newCityzen = cityzen.filter(item => !selected.includes(item))
        cityzen.splice(0, cityzen.length)
        cityzen.push(...newCityzen)
