...
<!--Input Search-->
      ...
      ></v-text-field>
<!--Button add-->
      <nuxt-link tag="button" to="/survey/create" class="index__btn mt-2 ms-2">Добавить</nuxt-link>
      <v-spacer></v-spacer>
<!--Button filter-->
      <v-menu open-on-click transition="slide-x-transition" offset-y>
          ...
          <v-card class="mx-auto" width="222px" tile>
              <v-list dense>
                  ...
                  <v-subheader @click="sortByFilter('pod')" class="menu-items">По названию приема, об...</v-subheader>
