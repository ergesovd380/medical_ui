...
<!--Название болезни-->
        <v-row>
          <v-col class="col-4">
          <h1 class="main-name">Ganyň lagtalanmak ulgamynyň görkezijileri №</h1>
          </v-col>
          <v-col class="col-2">
            <v-text-field
              filled
...
<!--Spisok-->
        ...
        <v-row>
          <v-col class="col-4">
            <h1 class="ms-4 main-name">Kada</h1>
          </v-col>
          <v-col>        
            <v-text-field
              filled
        ...
        <v-row>
          <v-col class="col-4">
            <h1 class="ms-4 main-name">Lagtalanma wagty</h1>
          </v-col>
          <v-col>        
            <v-text-field
              filled
        ...
        <v-row>
          <v-col class="col-4">
            <h1 class="ms-4 main-name">min</h1>
          </v-col>
          <v-col>        
            <v-text-field
              filled
        ...
        <v-row>
          <v-col class="col-4">
            <h1 class="ms-4 main-name">Gan akmanyň wagty</h1>
          </v-col>
          <v-col>        
            <v-text-field
              filled
        ...
        <v-row>
          <v-col class="col-4">
            <h1 class="ms-4 main-name">Protrombin indeksi</h1>
          </v-col>
          <v-col>        
            <v-text-field
              filled
        ...
        <v-row>
          <v-col class="col-4">
            <h1 class="ms-4 main-name">90-105%</h1>
          </v-col>
          <v-col>        
            <v-text-field
              filled
        ...
        <v-row>
          <v-col class="col-4">
            <h1 class="ms-4 main-name">AÇTW</h1>
          </v-col>
          <v-col>        
            <v-text-field
              filled
        ...
        <v-row>
          <v-col class="col-4">
            <h1 class="ms-4 main-name">22-36 sek.</h1>
          </v-col>
          <v-col>        
            <v-text-field
              filled
        ...
        <v-row>
          <v-col class="col-4">
            <h1 class="ms-4 main-name">Fibrinogen</h1>
          </v-col>
          <v-col>        
            <v-text-field
              filled
        ...
        <v-row>
          <v-col class="col-4">
            <h1 class="ms-4 main-name">1-75-4.00 g</h1>
          </v-col>
          <v-col>        
            <v-text-field
              filled
        ...
        <v-row>
          <v-col class="col-4">
            <h1 class="ms-4 main-name">Reklasifikasiýa wagty</h1>
          </v-col>
          <v-col>        
            <v-text-field
              filled
        ...
        <v-row>
          <v-col class="col-4">
            <h1 class="ms-4 main-name">60-120 sek.</h1>
          </v-col>
          <v-col>        
            <v-text-field
              filled
        ...
        <v-row>
          <v-col class="col-4">
            <h1 class="ms-4 main-name">Trombiniň wagty</h1>
          </v-col>
          <v-col>        
            <v-text-field
              filled
        ...
        <v-row>
          <v-col class="col-4">
            <h1 class="ms-4 main-name">11.3-18.5 sek.</h1>
          </v-col>
          <v-col>        
            <v-text-field
              filled
        ...
        <v-row>
          <v-col class="col-4">
            <h1 class="ms-4 main-name">Geparine tolerantlylygy</h1>
          </v-col>
          <v-col>        
            <v-text-field
              filled
        ...
        <v-row>
          <v-col class="col-4">
            <h1 class="ms-4 main-name">7-15 min.</h1>
          </v-col>
          <v-col>        
            <v-text-field
              filled
        ...
        <v-row>
          <v-col class="col-4">
            <h1 class="ms-4 main-name">6-11 min.</h1>
          </v-col>
          <v-col>        
            <v-text-field
              filled
        ...
        <v-row>
          <v-col class="col-4">
            <h1 class="ms-4 main-name">Etalonyň testi</h1>
          </v-col>
          <v-col>        
            <v-text-field
              filled
        ...
        <v-row>
          <v-col class="col-4">
            <h1 class="ms-4 main-name">Fibriniň dörän wagty</h1>
          </v-col>
          <v-col>        
            <v-text-field
              filled
        ...
        <v-row>
          <v-col class="col-4">
            <h1 class="ms-4 main-name">Negative</h1>
          </v-col>
          <v-col>        
            <v-text-field
              filled
        ...
        <v-row>
          <v-col class="col-4">
            <h1 class="ms-4 main-name">Maşgala meýdançasy</h1>
          </v-col>
          <v-col>        
            <v-text-field
              filled
