...
<!--Название болезни-->
        <v-row>
          <v-col class="col-4">
          <h1 class="main-name">ELLERIŇ ARTERIÝALARYNYŇ <br> DUPLEKS SKAN BARLAGYNYŇ BEÝANY</h1>
          </v-col>
          <v-col class="col-2">
            <v-text-field
              filled
...
<!--Spisok-->
        <v-row>
          <v-col>
            <h1 class="main-name ms-4">Ýaýjykasty arteriýasy</h1>
          </v-col>
          <v-col>
            <v-row>
              <v-col>
        ...
        <v-row>
          <v-col>
            <h1 class="main-name ms-4">Çigin arteriýasy</h1>
          </v-col>
          <v-col>
            <v-row>
              <v-col>
        ...
        <v-row>
          <v-col>
            <h1 class="main-name ms-4">Bilek arteriýasy</h1>
          </v-col>
          <v-col>
            <v-row>
              <v-col>
        ...
        <v-row>
          <v-col>
            <h1 class="main-name ms-4">Bilek-penje arteriýasy</h1>
          </v-col>
          <v-col>
            <v-row>
              <v-col>
