<template>
  <section class="blank">
    ...
    >
<!--Header-->
      <nuxt-link no-prefetch tag="button" to="/blank" class="main-btn mt-2 ms-2">{{ $t("Back") }}</nuxt-link>
      <v-spacer></v-spacer>
...
<!--Sag chep gechiriji-->
      <v-row>
          <v-col class="offset-4">
            <h4 class="ms-4">Sag geçiriji</h4>
          </v-col>
          <v-col>
            <h4 class="ms-4">Çep geçiriji</h4>
          </v-col>
      </v-row>
<!--Spiok-->
      <v-row>
