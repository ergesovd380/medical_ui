...
<!--Название болезни-->
        <v-row>
          <v-col class="col-4">
          <h1 class="main-name">GANYŇ TOPARY WE REZUS-FAKTOR <br>BARLAGYNYŇ NETIJESI</h1>
          </v-col>
          <v-col class="col-2">
            <v-text-field
              filled
...
<!--Result-->
        <div class="my-10">
          <h1 class="main-name text-center">Barlagyň netijesi</h1>
        </div>
        <v-row>
          <v-col class="col-4">
            <h1 class="main-name ms-4 mt-4">Ganyň topary</h1>
          </v-col>
          <v-col class="col-7">
            <v-text-field
              filled
          ...
          <v-col class="col-1">
            <h1 class="main-name mt-4">mmol/l</h1>
          </v-col>
          <v-col class="col-4">
            <h1 class="main-name ms-4 mt-4">Rezus-faktor</h1>
          </v-col>
          <v-col class="col-7">
            <v-text-field
              filled
