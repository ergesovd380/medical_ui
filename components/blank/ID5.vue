...
<!--Название болезни-->
      <v-row>
        <v-col class="col-4">
        <h1 class="blank__name">Immunoferment derňeiniň netijesi №</h1>
        </v-col>
        <v-col class="col-2">
          <v-text-field
            filled
...
<!--Spisok-->
      <v-row>
        <v-col class="col-4">
          <h1 class="ms-4 blank__name">Testiň gönüşi</h1>
        </v-col>
        <v-col>        
          <v-text-field
            filled
      ...
      <v-row>
        <v-col class="col-4">
          <h1 class="ms-4 blank__name">Anti-HCV Ig G</h1>
        </v-col>
        <v-col>        
          <v-text-field
            filled
      ...
      <v-row>
        <v-col class="col-4">
          <h1 class="ms-4 blank__name">Anti-HCV-NS</h1>
        </v-col>
        <v-col>        
          <v-text-field
            filled
      ...
      <v-row>
        <v-col class="col-4">
          <h1 class="ms-4 blank__name">HBs Ag</h1>
        </v-col>
        <v-col>        
          <v-text-field
            filled
      ...
      <v-row>
        <v-col class="col-4">
          <h1 class="ms-4 blank__name">Anti-HBe (anti- CORE)</h1>
        </v-col>
        <v-col>        
          <v-text-field
            filled
      ...
      <v-row>
        <v-col class="col-4">
          <h1 class="ms-4 blank__name">Anti-HBs Ag</h1>
        </v-col>
        <v-col>        
          <v-text-field
            filled
      ...
      <v-row>
        <v-col class="col-4">
          <h1 class="ms-4 blank__name">Anti-HDV</h1>
        </v-col>
        <v-col>        
          <v-text-field
            filled
      ...
      <v-row>
        <v-col class="col-4">
          <h1 class="ms-4 blank__name">HIV</h1>
        </v-col>
        <v-col>        
          <v-text-field
            filled
      ...
      <v-row>
        <v-col class="col-4">
          <h1 class="ms-4 blank__name">Helicobacter pylori Ig G</h1>
        </v-col>
        <v-col>        
          <v-text-field
            filled
      ...
      <v-row>
        <v-col class="col-4">
          <h1 class="ms-4 blank__name">Chlamydia trachomatis IgM</h1>
        </v-col>
        <v-col>        
          <v-text-field
            filled
      ...
      <v-row>
        <v-col class="col-4">
          <h1 class="ms-4 blank__name">Chlamydia trachomatis IgG</h1>
        </v-col>
        <v-col>        
          <v-text-field
            filled
      ...
      <v-row>
        <v-col class="col-4">
          <h1 class="ms-4 blank__name">Toxoplazma IgM</h1>
        </v-col>
        <v-col>        
          <v-text-field
            filled
      ...
      <v-row>
        <v-col class="col-4">
          <h1 class="ms-4 blank__name">Toxoplazma IgG</h1>
        </v-col>
        <v-col>        
          <v-text-field
            filled
      ...
      <v-row>
        <v-col class="col-4">
          <h1 class="ms-4 blank__name">CMV IgM</h1>
        </v-col>
        <v-col>        
          <v-text-field
            filled
      ...
      <v-row>
        <v-col class="col-4">
          <h1 class="ms-4 blank__name">CMV IgG</h1>
        </v-col>
        <v-col>        
          <v-text-field
            filled
      ...
      <v-row>
        <v-col class="col-4">
          <h1 class="ms-4 blank__name">Ureaplazma Ig G</h1>
        </v-col>
        <v-col>        
          <v-text-field
            filled
      ...
      <v-row>
        <v-col class="col-4">
          <h1 class="ms-4 blank__name">Mycoplazma Ig G</h1>
        </v-col>
        <v-col>        
          <v-text-field
            filled
