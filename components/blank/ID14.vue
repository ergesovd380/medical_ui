...
<!--Название болезни-->
        <v-row>
          <v-col class="col-4">
          <h1 class="main-name">GANYŇ LAGTALANMAK ULGAMYNYŇ <br>GÖRKEZIJILERI №</h1>
          </v-col>
          <v-col class="col-2">
            <v-text-field
              filled
...
<!--Result-->
        <v-row>
          ...
          <v-col class="col-5">
            <h1 class="main-name">Kada</h1>
          </v-col>
<!--Spisok-->
          <v-col class="col-3">
            <h1 class="ms-4 mt-4 main-name">Lagtalanma wagty</h1>
          </v-col>
          <v-col class="col-4">
            <v-text-field
              filled
          ...
          <v-col class="col-5">
            <h1 class="mt-4 main-name">min.</h1>
          </v-col>
          <v-col class="col-3">
            <h1 class="ms-4 mt-4 main-name">Gan akmagynyň wagty wagty</h1>
          </v-col>
          <v-col class="col-4">
            <v-text-field
              filled
          ...
          <v-col class="col-3">
            <h1 class="ms-4 mt-4 main-name">Protrombin indeksi</h1>
          </v-col>
          <v-col class="col-4">
            <v-text-field
              filled
          ...
          <v-col class="col-5">
            <h1 class="mt-4 main-name">90-105%</h1>
          </v-col>
          <v-col class="col-3">
            <h1 class="ms-4 mt-4 main-name">AÇTW</h1>
          </v-col>
          <v-col class="col-4">
            <v-text-field
              filled
          ...
          <v-col class="col-5">
            <h1 class="mt-4 main-name">22-36 sek.</h1>
          </v-col>
        </v-row>
      </div>
    </v-form>
