...
<!--Header-->
      ...
      <v-text-field
        ...
        flat
      ></v-text-field>
      <v-btn icon class="mt-2 ms-2 blan__filter-btn">
        <v-icon>
          mdi-printer-outline
        </v-icon>
      </v-btn>
...
<!--Название болезни-->
      <v-row>
        <v-col class="col-4">
        <h1 class="blank__name">GANYŇ LAGTALANMAK ULGAMYNYŇ <br>GÖRKEZIJILERI №</h1>
        </v-col>
        <v-col class="col-2">
          <v-text-field
            filled
...
<!--Cabinet, Toleg belgisi-->
    <v-row>
      <v-col>
        <div class="ms-4">Töleg belgisi</div>
        <v-autocomplete
          filled
          rounded
          dense
...
<!--Family field-->
    <v-row>
      <v-col class="col-3">
        <h1 class="ms-4 mt-4 blank__name">Maşgala meýdançasy</h1>
      </v-col>
      <v-col>
        <v-textarea
          filled
...
<!--Result-->
      <v-row>
        <v-col class="offset-3 text-center col-4">
          <h1 class="blank__name">Netije</h1>
        </v-col>
        <v-col class="col-5">
          <h1 class="blank__name">Kada</h1>
        </v-col>
<!--Spisok-->
        <v-col class="col-3">
          <h1 class="ms-4 mt-4 blank__name">Lagtalanma wagty</h1>
        </v-col>
        <v-col class="col-4">
          <v-text-field
            filled
        ...
        <v-col class="col-5">
          <h1 class="mt-4 blank__name">min.</h1>
        </v-col>
        <v-col class="col-3">
          <h1 class="ms-4 mt-4 blank__name">Gan akmagynyň wagty wagty</h1>
        </v-col>
        <v-col class="col-4">
          <v-text-field
            filled
        ...
        <v-col class="col-3">
          <h1 class="ms-4 mt-4 blank__name">Protrombin indeksi</h1>
        </v-col>
        <v-col class="col-4">
          <v-text-field
            filled
        ...
        <v-col class="col-5">
          <h1 class="mt-4 blank__name">90-105%</h1>
        </v-col>
        <v-col class="col-3">
          <h1 class="ms-4 mt-4 blank__name">AÇTW</h1>
        </v-col>
        <v-col class="col-4">
          <v-text-field
            filled
        ...
        <v-col class="col-5">
          <h1 class="mt-4 blank__name">22-36 sek.</h1>
        </v-col>
      </v-row>
    </v-form>
  </section>
