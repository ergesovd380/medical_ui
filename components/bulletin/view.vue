...
<!--Button lang-->
      <button class="main-btn mt-2 ms-2">{{ $t('Turkmen') }}</button>
      <button class="main-btn mt-2 ms-2">{{ $t('Russian') }}</button>
...
export default {
  data(): any {
    return {
      textturkmen: `
      <h1>Saglygy goraýyş we derman senagaty ministrliginiň bildirişi</h1> 
      <br> 
